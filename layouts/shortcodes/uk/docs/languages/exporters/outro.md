...
Нарешті, ви також можете написати свій власний експортер. Для отримання додаткової інформації дивіться [Інтерфейс SpanExporter в документації API]({{ $spanExporterInterfaceUrl }}).
