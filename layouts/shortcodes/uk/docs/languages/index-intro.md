...
{{ $tracesStatus := partial "uk/docs/get-signal-status.html" (dict "lang" $lang "signal" "traces") -}}
{{ $metricsStatus := partial "uk/docs/get-signal-status.html" (dict "lang" $lang "signal" "metrics") -}}
{{ $logsStatus := partial "uk/docs/get-signal-status.html" (dict "lang" $lang "signal" "logs") -}}
