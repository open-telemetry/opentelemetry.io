...
export function registerLiveChecks(registerTest = test) {
  ...
  registerTest('HEAD /docs.html → redirect toward /docs/', async () => {
  ...
  registerTest(
    'GET /site/testing/tests/regular-alias/ → redirect toward canonical page',
    async () => {
  ...
  registerTest(
    'GET /site/testing/tests/no-md-alias/ → redirect toward canonical page',
    async () => {
