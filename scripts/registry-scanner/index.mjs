...
async function createFilesFromScrapeResult(existing, found, settings) {
    const { language, registryType } = settings
...
async function scrapeInstrumentationLibrariesByLanguage(language, path) {
    ...
    const existing = scrapeExisting(`instrumentation-${language}`)
