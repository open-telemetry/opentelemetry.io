...
Iris 氏は[オブザーバビリティ](/docs/concepts/observability-primer/)と OpenTelemetry の熱烈なファンであり、これら 2 つのトピックへの情熱は非常に感染力があります。
...
ユーザーのフィードバックを大切にしており、すべてのユーザーの皆さんに体験を共有していただき、OpenTelemetry の改善を続けていくことを推奨しています。
❣️
