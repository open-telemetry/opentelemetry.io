...
params:
  alertExamples: |
    > [!TIP]
    >
    > 新しいコンテンツを書く場合、通常は Docsy の [alert shortcode](https://www.docsy.dev/docs/content/shortcodes/#alert) ではなく、このblockquoteアラート構文を使用することを推奨します。
...
blockquoteアラート構文の詳細については、Docsy ドキュメントの [アラート][docsy-alerts] を参照してください。
