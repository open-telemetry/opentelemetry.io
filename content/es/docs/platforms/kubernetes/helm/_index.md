...
Si eliges usar Helm, puedes usar [las charts de Helm para OpenTelemetry](https://github.com/open-telemetry/opentelemetry-helm-charts) para gestionar
las instalaciones del [OpenTelemetry Collector](/docs/collector),
