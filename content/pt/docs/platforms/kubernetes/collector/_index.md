...
O [OpenTelemetry Collector](/docs/collector/) é agnóstico a fornecedores,
permitindo receber, processar e exportar dados de telemetria. Embora o Collector
possa ser usado em diversos contextos, esta documentação foca em como usá-lo
para monitorar o Kubernetes e os serviços em execução nele. Para uma
