...
resource usage. See [Sampling](/docs/languages/java/sdk/#amostrador).
...
Recursos ex Java agent might increase agent overhead due to the experimental
focus on functionality over performance. Stable features are safer in terms of
agent overhead.
...
- Cheque os requisitos mínimos. Veja
  [Pré requisitos](/docs/languages/java/getting-started/#pré-requisitos).
- Use a versão mais recente compatível com o Java agent.
- Use a versão mais recente compatível com o seu JVM.
