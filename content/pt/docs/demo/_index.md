...
como instalar e executar o demo, além de alguns cenários que você pode usar para
ver o OpenTelemetry em ação.

## Executando o Demo {#running-the-demo}

Quer implantar o demo e vê-lo em ação? Comece por aqui.
