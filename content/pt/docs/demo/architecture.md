...
O **Demo do OpenTelemetry** é composto por microsserviços escritos em diferentes
linguagens de programação que se comunicam via gRPC e HTTP; e um gerador de
carga que usa [Locust](https://locust.io/) para simular tráfego de usuários.
...
Encontre as **Definições de Protocol Buffer** no diretório `/pb/`.
