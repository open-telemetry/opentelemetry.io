...
configuração por teste e enviam tráfego por meio do Collector. Informações
adicionais sobre o ambiente de testes podem ser encontradas no
...
Um subconjunto dos resultados é exibido abaixo. Para todos os resultados,
consulte [Benchmarks do Collector](https://open-telemetry.github.io/opentelemetry-collector-contrib/benchmarks/loadtests/).
