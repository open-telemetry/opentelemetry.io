...
[limites de trechos](../sdk/#spanlimits), [limites de logs](../sdk/#loglimits)):
...
**[1]**: Propagadores conhecidos e artefatos (Veja
...
Propriedades para [processadores em lote de trechos](../sdk/#spanprocessor) em
...
Implementa a interface do `ResourceProvider` para participar no recurso de auto
...
para customizar uma variedade de componentes do SDK auto configurados. Por
exemplo:
