...
| `otel.exporter.otlp.headers`                               | Pares de chave-valor separados por vírgulas para passar os headers de requisições em um traço OTLP, métrica, e requisiçõe de registros.                                                                                                                                                                                                                                                                                                                        |                                                                                                                            |
...
Implementa a interface do `ResourceProvider` para participar no recurso
de auto configuração. Por exemplo:
...
para customizar uma variedade de componentes do SDK auto configurados. Por exemplo:
