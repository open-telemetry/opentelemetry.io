...
O SDK do OpenTelemetry para JavaScript executa testes de benchmark em cada
commit no repositório
[opentelemetry-js](https://github.com/open-telemetry/opentelemetry-js/). A
intenção desses testes é rastrear a tendência de desempenho de operações
críticas ao longo do tempo. Esses testes não são um substituto para testes de
