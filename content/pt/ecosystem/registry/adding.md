...
`registryType`. Este campo categoriza seu projeto com base em sua relação com o
...
nativamente (suporte nativo) sem necessidade de plugins externos ou bibliotecas
de instrumentação.
