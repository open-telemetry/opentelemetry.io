...
| Field       | Description                                                                                                                                       |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| **id**      | A unique identifier (date + short description) printed in log messages.                                                                           |
...
| **file**    | A compiled regex (`qr|...|`) matching the file paths the patch should apply to.                                                                   |
...
When you see this message, delete the patch entry from the `@patches` array.
