...
| `check:filenames`      | [Validate file naming & no of obsolete files/folders][fn].  |
...
| `fix:filenames`           | [Rename files and remove obsolete files/folders][fn].          |
...
| `all`                                              | Run run all given scripts even if some fail, then exit with failure if any failed. |
