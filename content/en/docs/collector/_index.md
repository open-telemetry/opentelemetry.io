...
The Collector is commonly deployed in one of two ways:

1. client app -> popular backends
2. client app -> collector -> popular backends

That distinction is important because the diagram above is only a high-level overview.
