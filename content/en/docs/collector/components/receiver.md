...
| {{< component-link name="azureeventhubreceiver" type="receiver" repo="contrib" >}}          | contrib                  | alpha       | alpha        | alpha        |
| {{< component-link name="azuremonitorreceiver" type="receiver" repo="contrib" >}}           | contrib                  | -           | alpha        | -            |
| {{< component-link name="bigipreceiver" type="receiver" repo="contrib" >}} ⚠️               | contrib                  | -           | unmaintained | -            |
| {{< component-link name="carbonreceiver" type="receiver" repo="contrib" >}} ⚠️              | contrib                  | -           | unmaintained | -            |
