...
Assuming you already have a system generating some kind of tracing telemetry, [the OpenTelemetry Collector](/docs/collector) is the doorway to help you make it available into the OTel world.
