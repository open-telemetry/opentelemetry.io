...
| `failedReadinessProbe`              | Cart            | Make readiness probe fails with unhealthy status resulting pod gettting into not ready status. This is applicable only for Kubernetes based deployment.            |
