...
| [frontend](../services/frontend/)                     | JavaScript    | Exposes an HTTP server to serve the site. Does not require sign up / login and generates session IDs for all users automatically.         |
