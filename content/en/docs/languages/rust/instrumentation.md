...
For logging, OpenTelemetry Rust recommends using existing logging crates such as
[`tracing`](https://docs.rs/tracing) or [`log`](https://docs.rs/log) for
instrumenting your code, rather than using the OTel log APIs directly. The OTel
log bridge APIs are available for bridging these existing logging frameworks
into OpenTelemetry data.
