...
```console
$ cargo add opentelemetry --features metrics
$ cargo add opentelemetry_sdk --features trace,metrics,logs
$ cargo add opentelemetry-stdout --features trace,metrics,logs
$ cargo add opentelemetry-appender-tracing
$ cargo add tracing
