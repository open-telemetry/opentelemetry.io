...
If the application runs as ESM, add the loader hook as specified in the [ESM Support Doc](https://github.com/open-telemetry/opentelemetry-js/blob/main/doc/esm-support.md).
{{% /alert %}}
