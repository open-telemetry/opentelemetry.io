...
complete the [packages named `resource-detector-*` in the opentelemetry-js-contrib repo](https://github.com/open-telemetry/opentelemetry-js-contrib/tree/main/packages).
