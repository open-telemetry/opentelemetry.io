...
Run an instrumentable Ruby service or download and run a simple example
[Ruby HTTP service](https://github.com/grafana/beyla/tree/main/examples/quickstart/ruby).
...
`ruby`. To override it, refer to the
[override service name and namespace](/docs/zero-code/obi/configure/service-discovery/#override-service-name-and-namespace)
...
- `svc=[{quickstart ruby lima-ubuntu-lts-5074}]`: `quickstart` service, running
  in Ruby, with an automatically created service instance name
