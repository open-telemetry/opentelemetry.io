...
title: Resources
weight: 70
cSpell:ignore: myhost SIGINT uuidgen WORKDIR getenv
---

A [resource](/docs/specs/otel/resource/sdk/) represents the entity producing telemetry as resource attributes.
...
If you use the Javaagent for [automatic instrumentation](/docs/instrumentation/java/automatic) you
can learn how to setup resource detection following the [Agent Configuration Guide]/docs/instrumentation/java/automatic/agent-config)
