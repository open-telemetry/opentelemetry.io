...
You can apply or edit configuration settings in the following ways,
...
On .NET, the .NET CLR Profiler is used only for bytecode instrumentation.
If having just source instrumentation is acceptable,
