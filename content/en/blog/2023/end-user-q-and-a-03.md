...
code. Among other things, the [OTel Operator](/docs/kubernetes/k8s-operator/)
...
[OTel Operator](/docs/kubernetes/k8s-operator/) instead, which allows you to
deploy and configure the OTel Collector and inject and configure
