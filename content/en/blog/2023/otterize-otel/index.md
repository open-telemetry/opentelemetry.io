...
linkTitle: "OTel and Otterize" # Mandatory, make sure that your short title.
date: 2023-11-15 # Put the current date, we will keep the date updated until your PR is merged
author: "Ori Shoshan" >- # If you have only one author, then add the single name on this line in quotes.
