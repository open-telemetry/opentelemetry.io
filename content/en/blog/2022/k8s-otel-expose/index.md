...
- A Kubernetes[v1.23.3] cluster with a public address with
  [ingress-nginx-controller](https://docs.nginx.com/nginx-ingress-controller/)[v1.2.1] installed.
...
collector image was overwritten with the
...
Let's have a quick look on the most important edge collector settings. A `daemonset` is
