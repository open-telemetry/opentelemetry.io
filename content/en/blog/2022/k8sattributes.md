...
Attaching attributes to the traces is something that is very useful in the
Kubernetes environments for determine which resource emits certain spans, this
will help us to determine exactly which resource is failing or having
...
attached to it. This information could be useful for correlating the spans with
other signals generated by the collector like metrics and logs.
