...
[2.0][java-instrumentation-v2.0.0], but the audit surfaced gaps that we fixed
along the way. Seeing those gaps helps the SIG prioritize work and check its
progress.
