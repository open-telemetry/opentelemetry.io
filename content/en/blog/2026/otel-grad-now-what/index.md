...
> For end users, this graduation signals that OTel is far from being an
> "emerging standard". Its contributor health, security and quality standards,
> governance processes, and wide adoption have been evaluated to be at the level
> required by any enterprise, of any scale. So, if you're in the 25% of skeptics
> not using OTel, there's really no excuse anymore. There has never been a
> better time to adopt it!
