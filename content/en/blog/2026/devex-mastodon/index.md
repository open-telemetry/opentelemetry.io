...
- [mastodon.social](https://mastodon.social)
  ...
  RAM each). Web frontends scale between 5 and 20 pods, while various Sidekiq
...
- [mastodon.online](https://mastodon.online)
  ...
  each). Web frontends scale between 3 and 10 pods, and Sidekiq pools scale
...
A full production configuration is included below for reference (you can also view it on [otelbin][otelbin-mastodon]):
