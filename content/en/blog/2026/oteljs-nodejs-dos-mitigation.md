---
title: OpenTelemetry Statement on Node.js DOS Vulnerability
...
exists in Node.js itself and affects Node.js versions prior to Node.js 24 where
`AsyncLocalStorage` is implemented on top of `async_hooks`.

The Node.js team has fixed the issue in **Node.js 20.20.0 and newer. This fix is
not being backported to Node.js 18**, so the recommended mitigation is to
upgrade to Node.js 20+ if you haven’t already. Review
...
visibility but is not considered by V8 to be a security issue.
