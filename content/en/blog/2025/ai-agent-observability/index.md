...
For more information about AI agents, check out the following resources:
...
Both option 1 and option 2 works well, but the long term goal is we should host
the code in OpenTelemetry owned repositories, like Traceloop is trying to
...
## The role of OpenTelemetry's GenAI SIG
