---
title: 'New Configurate Schema release candidate'
...
examples, and the resulting JSON schema more consistently. For anyone looking to
contribute, read more details about the tooling and the process in the
[contributing][contrib-doc] documentation.
