...
monitoring data. You can choose any backend of you rliking to store OTEL metrics
and traces.
...
vendor-specific span attributes or environment variables for OTLP endpoint
configuration, offering a standard solution.
