...
When linking to source code in GitHub repositories, **do not link to the `main` (or other default) branch**.  
Instead, link to a **specific commit** or a **tagged release** that reflects the state of the code at the time the blog post was written.
