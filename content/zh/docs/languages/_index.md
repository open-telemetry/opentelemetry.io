...
对于 Go、.NET、PHP、Python、Java 和 JavaScript，你可以使用[自动插桩解决方案](/docs/zero-code)将插桩添加到你的应用，无需修改代码。

如果你正在使用 Kubernetes，可以借助 [Kubernetes 的 OpenTelemetry Operator][otel-op] 向你的应用中[注入这些自动插桩解决方案][zero-code]。
