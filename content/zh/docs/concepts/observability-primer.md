...
要对你的系统提出这些问题，你的应用程序必须进行适当的仪器化。也就是说，应用程序代码必须能够发出[信号](/docs/concepts/signals/)，
例如[链路](/docs/concepts/signals/traces/)、
[指标](/docs/concepts/signals/metrics/)和
[日志](/docs/concepts/signals/logs/)。当开发人员不需要添加更多仪器就能排查问题时，
我们就可以说这个应用程序已经完成了适当的仪器化，因为他们已经拥有了所需的所有信息。

[OpenTelemetry](/docs/what-is-opentelemetry/)就是一种为应用程序代码进行仪器化的机制，它的目的是帮助使系统变得可观测。
