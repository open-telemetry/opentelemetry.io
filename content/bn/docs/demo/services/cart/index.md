...
> **নোট** .NET-এর জন্য OpenTelemetry `System.Diagnostic.DiagnosticSource` লাইব্রেরিকে
> API হিসেবে ব্যবহার করে, স্ট্যান্ডার্ড OpenTelemetry API-এর পরিবর্তে ট্রেস এবং মেট্রিক্স-এর জন্য।
...
অপশন কনফিগার করতে ব্যবহৃত হয়। এক্সপোর্টার এবং রিসোর্স অ্যাট্রিবিউট কনফিগারেশন পরিবেশ
...
স্প্যানে (activity) অ্যাট্রিবিউট (.NET tag) যোগ করতে `SetTag` ব্যবহার করা হয়।
`services/CartService.cs`-এর `AddItem` ফাংশনে কয়েকটি অ্যাট্রিবিউট অটো-ইনস্ট্রুমেন্টেড স্প্যানে যোগ
করা হয়েছে।
