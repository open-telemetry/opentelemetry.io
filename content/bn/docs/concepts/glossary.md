...
পরিমাপগুলোর সম্পর্কে সুনির্দিষ্ট বা অনুমানভিত্তিক
পরিসংখ্যানে একাধিক
...
পাশাপাশি বাণিজ্যিক চাহিদাও রয়েছে। OpenTelemetry একটি observability backend নয়।
...
হতে পারে, বিশেষ করে যখন বাণিজ্যিক চাহিদা বিবেচনা করা হয়।
...
vendor-agnostic টেলিমেট্রি ডেটা প্রদানের জন্য [Metadata](#metadata)-এর নাম এবং
মান সংজ্ঞায়িত করে।
