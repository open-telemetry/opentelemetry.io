...
- [Мовні API та SDK реалізації](#language-specific-api--sdk-implementations)
  ...
  - [Кросс-сервісні поширювачі](#cross-service-propagators)
  - [Семплери](#samplers)
...
Для отримання додаткової інформації дивіться [K8s Оператор](/docs/kubernetes/operator/).
...
Для отримання додаткової інформації дивіться [Функції як сервіс](/docs/faas/).
