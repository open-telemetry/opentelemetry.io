...
Щоб ставити ці питання про вашу систему, ваш застосунок повинен бути належним чином інструментований. Тобто, код додатка повинен генерувати [сигнали](/docs/concepts/signals/), такі як [трейси](/docs/concepts/signals/traces/),
