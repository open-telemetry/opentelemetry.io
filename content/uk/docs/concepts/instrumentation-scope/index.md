...
[Область застосування інструментування](/docs/specs/otel/glossary/#instrumentation-scope) представляє логічну одиницю в коді застосунку, з якою можна асоціювати поширювану телеметрію.
