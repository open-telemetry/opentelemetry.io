...
- Поки ваша інструменталізація стабілізується, розгляньте можливість її випуску як окремого пакету, щоб вона ніколи не викликала проблем для користувачів, які її не використовують. Ви можете зберігати її у вашому репозиторії або [додати її до OpenTelemetry](https://github.com/open-telemetry/oteps/blob/main/text/0155-external-modules.md#contrib-components), щоб вона постачалася разом з іншими бібліотеками інструментування.
