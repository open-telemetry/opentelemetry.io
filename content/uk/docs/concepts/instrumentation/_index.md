...
Для того, щоб зробити систему спостережуваною, її необхідно **інструментувати**: тобто код компонентів системи повинен генерувати [трейси](/docs/concepts/signals/traces/), [метрики](/docs/concepts/signals/metrics/) та [логи](/docs/concepts/signals/logs/).

Використовуючи OpenTelemetry, ви можете інструментувати свій код двома основними способами:

1. [Рішення на основі коду](/docs/concepts/instrumentation/code-based) через офіційні [API та SDK для більшості мов](/docs/languages/)
2. [Рішення без коду](/docs/concepts/instrumentation/zero-code/)
...
- Для кожного [сигналу](/docs/concepts/signals) (трейси, метрики, логи) у вас є кілька методів для створення, обробки та експорту.
- Завдяки [поширенню контексту](/docs/concepts/context-propagation), вбудованій в реалізації, ви можете корелювати сигнали незалежно від того, де вони згенеровані.
- [Ресурси](/docs/concepts/resources) та [Області інструментування](/docs/concepts/instrumentation-scope) дозволяють групувати сигнали за різними сутностями, такими як [хост](/docs/specs/semconv/resource/host/), [операційна система](/docs/specs/semconv/resource/os/) або [кластер K8s](/docs/specs/semconv/resource/k8s/#cluster)
...
- [Семантичні домовленості](/docs/concepts/semantic-conventions) надають загальну схему найменування, яка може бути використана для стандартизації в різних кодових базах та платформах.
