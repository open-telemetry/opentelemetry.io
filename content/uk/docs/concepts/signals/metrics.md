...
- З **кумулятивною** темпоральністю SDK зберігає стан між циклами, тому після досягнення ліміту нові комбінації продовжують переповнюватися до перезапуску процесу.

Асинхронні інструменти дотримуються інших правил, які виходять за рамки цього огляду.
