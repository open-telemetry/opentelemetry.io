...
На відміну від [трасування запитів](/docs/concepts/signals/traces/), яке призначене для фіксації життєвих циклів запитів та надання контексту до окремих частин запиту, метрики призначені для надання статистичної інформації в агрегаті. Деякі приклади використання метрик включають:
