...
Кожен SDK на стороні клієнта або підлеглий (downstream) колектор налаштований з місцем розташування колектора:
...
exporters:
  prometheusremotewrite: # PRW експортер, для інгестації метрик до бекенду
