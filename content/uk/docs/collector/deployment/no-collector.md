...
Дивіться [код інструментування для мов програмування][instrumentation] для конкретних прикладів від початку до кінця, як експортувати сигнали з вашого додатка безпосередньо в бекенд.
...
- Потрібні зміни в коді, якщо змінюється збір, обробка або приймання
