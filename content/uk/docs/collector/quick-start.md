...
- Досліджуйте різні способи [встановлення Collector](../install/).
...
- Дізнайтеся, як
  [створити власний Collector за допомогою OpenTelemetry Collector Builder (OCB)](/docs/collector/extend/ocb/).
