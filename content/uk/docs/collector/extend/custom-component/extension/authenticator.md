...
Оскільки це розширення, автентифікатор повинен налаштувати необхідні ресурси (такі як ключі, клієнти або кеші) при [`Start`](https://pkg.go.dev/go.opentelemetry.io/collector/component#Component) й очистити все при `Shutdown`.
