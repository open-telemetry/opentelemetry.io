...
# prettier-ignore
cSpell:ignore: configgo debugexporter exampleconnector gomod gord Jaglowski mapstructure otlpreceiver pdata pmetric ptrace servicegraph spanmetrics struct uber
---
...
Додаткові деталі про повні можливості конектора можна знайти за наступними посиланнями: [Що таке Конектори в OpenTelemetry?](https://bindplane.com/blog/what-are-connectors-in-opentelemetry), [Конфігурації Конектора OpenTelemetry](/docs/collector/configuration/#connectors)
