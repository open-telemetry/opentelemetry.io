...
Ключі та загальноприйняті значення семантичних домовленостей ресурсів визначені в пакунку семантичних домовленостей OpenTelemetry: [`go.opentelemetry.io/otel/semconv/v1.43.0`](https://pkg.go.dev/go.opentelemetry.io/otel/semconv/v1.43.0).
