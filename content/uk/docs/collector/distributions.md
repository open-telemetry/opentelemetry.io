...
{{% alert title="Примітка" color="warning" %}} OpenTelemetry **не перевіряє і не підтримує** сторонні дистрибутиви, наведені в наступній таблиці. Список надано для зручності спільноти. {{% /alert %}}
