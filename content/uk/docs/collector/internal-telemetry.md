...
`service.name`, `service.version` та `service.instance.id` (випадково згенеровані) атрибути ресурсу будуть автоматично прикріплені до внутрішніх телеметричних сигналів Колектора. Їх можна відключити, встановивши значення атрибута в `null` (наприклад, `service.name: null`).
