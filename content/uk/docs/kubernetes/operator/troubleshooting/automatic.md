...
Якщо ви використовуєте можливість [OpenTelemetry Operator](/docs/kubernetes/operator) робити інʼєкцію [автоінструментування](/docs/kubernetes/operator/automatic) і не бачите жодних трейсів або метрик, дотримуйтесь цих кроків з усунення несправностей, щоб зрозуміти, що відбувається.
...
Нарешті, переконайтеся, що ви використовуєте правильний порт Collector. Зазвичай ви можете вибрати або `4317` (gRPC), або `4318` (HTTP); однак для [Python автоінструментування ви можете використовувати тільки `4318`](/docs/kubernetes/operator/automatic/#python).
