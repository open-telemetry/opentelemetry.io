...
Для отримання додаткової інформації дивіться [.NET Auto Instrumentation docs](/docs/zero-code/net/).
...
Вищенаведена анотація вказує OTel Operator шукати обʼєкт `Instrumentation` у просторі імен podʼа. Вона також вказує оператору впровадити Python автоінструментування у pod.
...
- **Чи автоінструментування для правильної мови?** Наприклад, при інструментуванні Python застосунку, переконайтеся, що анотація не вказує `instrumentation.opentelemetry.io/inject-java: "true"` замість цього.
