...
- Найпростіший і стандартний метод — встановити [cert-manager](https://cert-manager.io/docs/) і встановити `admissionWebhooks.certManager.create` у `true`. У цьому випадку cert-manager створить самопідписний сертифікат. Дивіться [встановлення cert-manager](https://cert-manager.io/docs/installation/kubernetes/) для отримання додаткової інформації.
