...
<!--
    Цей розділ відображає авторитетне джерело за адресою:
    https://github.com/open-telemetry/sig-security/blob/main/security-response.md#security-model

    Будь-які зміни слід вносити там спочатку, а потім синхронізувати сюди.
-->

Під час оцінки терміновості та важливості виправлення безпеки, конфіденційність та цілісність є нашими найвищими пріоритетами для всіх програмних артефактів OpenTelemetry.

На відміну від цього, ми не вважаємо, що стандартні налаштування програмних артефактів OpenTelemetry є безпечними щодо атак на доступність. Ми наполегливо рекомендуємо не використовувати небезпечні стандартні налаштування, де це можливо. Щоб забезпечити доступність, користувачі повинні вимагати автентифікації для своєї точки доступу, дотримуючись рекомендацій з [розділу Безпека нашого вебсайту](/docs/security/).

Додатково, проєкт OpenTelemetry не вважає наступне вразливостями безпеки:

- атака відмови в обслуговуванні з боку належним чином автентифікованих клієнтів
- атака на доступність точок доступу з боку належним чином автентифікованих клієнтів

Це все ще може вважатися помилками, і користувачі можуть повідомляти про них як про такі. Під час оцінки впливу на доступність, підтримувачі також враховують політики безпеки інших проєктів (наприклад, Prometheus) при оцінці вразливостей компонентів, які забезпечують сумісність з цими проєктами, а також рівень асиметрії щодо використання ресурсів, що використовується атакою.
