...
- Використовуйте [OpenTelemetry Collector Builder (`ocb`)](/docs/collector/custom-collector) для створення дистрибутива Collector, який використовує лише необхідні компоненти.
...
receivers:
  otlp:
    protocols:
      grpc:
        endpoint: otel-collector:4317 # Використовуйте ім'я сервісу з вашого файлу Docker compose
```
