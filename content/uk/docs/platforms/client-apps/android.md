...
vers:
  ot-android: 1.7.0
default_lang_commit: 2a86594be48d4c283baf247fad08b9c0a729830f
...
Виявляє умови Application Not Responding (ANR) і повідомляє про них як діапазони, допомагаючи виявити проблеми, повʼязані з блокуванням основного потоку. Див. [інструментацію ANR](https://github.com/open-telemetry/opentelemetry-android/blob/main/instrumentation/anr/README.md).
