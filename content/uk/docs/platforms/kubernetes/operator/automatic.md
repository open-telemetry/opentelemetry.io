...
Стандартно, автоінструментування логів Python увімкнено пакунком `opentelemetry-instrumentation-logging`. Якщо ви хочете вимкнути цю функцію, ви повинні встановити змінну середовища `OTEL_PYTHON_LOG_AUTO_INSTRUMENTATION` наступним чином:
...
> До версії оператора v0.149.0 це регулювався параметром `OTEL_PYTHON_LOGGING_AUTO_INSTRUMENTATION_ENABLED`, який зазвичай був встановлений у значення `false`
