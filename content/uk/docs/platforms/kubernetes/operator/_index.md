...
- [автоматичним інструментуванням робочих навантажень за допомогою бібліотек інструментування OpenTelemetry](https://github.com/open-telemetry/opentelemetry-operator/blob/main/docs/auto-instrumentation/README.md)
