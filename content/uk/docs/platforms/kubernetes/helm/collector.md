...
Стандартний конвеєр логів чарта використовує експортер `debug`. У поєднанні з `filelogreceiver` пресета `logsCollection` легко випадково передати експортовані логи назад у колектор, що може викликати "вибух логів".
