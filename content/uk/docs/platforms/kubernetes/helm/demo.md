...
Стандартний файл `values.yaml` чарту Demo готовий до встановлення. Всі компоненти мають налаштовані обмеження пам'яті для оптимізації продуктивності, що може викликати проблеми, якщо ваш кластер недостатньо великий. Вся установка обмежена ~4 гігабайтами памʼяті, але може використовувати менше.
