...
Ми рекомендуємо вмикати автоматичну інструменталізацію лише для бібліотек/фреймворків, які використовуються вашим застоснком.
