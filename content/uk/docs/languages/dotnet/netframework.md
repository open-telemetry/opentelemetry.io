...
Вам також потрібно буде налаштувати відповідний експортер для [експорту ваших телеметричних даних](/docs/languages/dornet/exporters) до одного або декількох бекендів телеметрії.
