...
Ця реалізація використовує комбінацію власного вибірника та `ActivityProcessor` (процесора відрізків), щоб досягти гібридного підходу:
...
1. Якщо батьківський вибірник вирішує відмовитися від активності, SDK повертає результат вибірки «Record-Only» (Тільки запис). Це гарантує, що процесор активності отримає цю активність.
...
### 1. Настроюваний вибірник на основі батьківського елемента, що дозволяє приймати рішення «Record-Only»:{#1-a-custom-parent-based-sampler-that-allows-record-only-decisions}
...
public class ParentBasedElseAlwaysRecordSampler : Sampler
{
    ...
    public override SamplingResult ShouldSample(in SamplingParameters samplingParameters)
    {
        ...
        // Це коренева активність. Використовуйте кореневий вибірник для прийняття рішення.
...
Коли ви запускаєте програму, використовуючи цей механізм вибірки і процесор, ви повинні побачити вихідні дані, схожі на такі:
