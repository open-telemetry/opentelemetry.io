...
TracerProvider є центральним компонентом SDK OpenTelemetry. Він містить усі налаштування для трасування, такі як механізми вибірки, процесори, експортери тощо, і є дуже гнучким у налаштуванні.
