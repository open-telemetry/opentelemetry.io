...
Ми використовуємо композитний механізм вибірки, який використовує два вибірники:

1. Вибірник на основі батьків.
2. Вибірник на основі звʼязків.

Цей композитний механізм вибірки спочатку делегує роботу вибірнику на основі батьків. Якщо вибірник на основі батьків вирішує провести вибірку, тоді композитний механізм вибірки також вирішує провести вибірку. Однак, якщо вибірник на основі батьків вирішує відмовитися, композитний механізм вибірки делегує роботу вибірнику на основі звʼязків. Вибірник на основі звʼязків вирішує провести вибірку, якщо активність має будь-які повʼязані активності і якщо принаймні ОДНА з цих повʼязаних активностей була вибрана.
