...
default_lang_commit: 85cd526b503bd9dd200f6c27792fd5109f7a9e4d
...
> [!IMPORTANT]
>
> Тримайте `TracerProvider` живим доки застосунок створює телеметрію, та явно видаляйте його під час вимкнення застосунку, щоб вивантажити будь-яку залишкову телеметрію. Для деталей див. [Управління TracerProvider](/docs/languages/dotnet/traces/best-practices/#tracerprovider-management).
...
> [!IMPORTANT]
>
> Імʼя кожного `ActivitySource` має відповідати імені, переданому в `AddSource` при налаштуванні `TracerProvider`; інакше активності, створені цим джерелом, не збираються. Якщо ваш застосунок визначає кілька імен `ActivitySource`, реєструйте кожне з `AddSource`.
