...
- Якщо ви звільните екземпляр `LoggerFactory` занадто рано, будь-який подальший виклик API журналювання, пов'язаний з фабрикою журналів, може стати бездіяльним (тобто жоден журнал не буде виведений).
