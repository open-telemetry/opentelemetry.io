...
{{% alert title="Примітка" %}} Підтримка теґів рівня інструменту ще не реалізована в OpenTelemetry .NET, оскільки [специфікація OpenTelemetry](/docs/specs/otel/metrics/api/#instrument) її не підтримує. {{% /alert %}}
