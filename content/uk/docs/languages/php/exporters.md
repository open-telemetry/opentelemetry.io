...
> [!NOTE]
>
> Якщо ви використовуєте [інструментування без коду](/docs/zero-code/php/), ви можете налаштувати експортери за допомогою [конфігурації без коду для налаштування експортерів](/docs/zero-code/php/auto/#configuration).
