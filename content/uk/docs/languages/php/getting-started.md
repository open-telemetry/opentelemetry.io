...
2. Зберіть розширення за допомогою `PECL`:
   ...
   > [!NOTE]
   >
   > Альтернативні методи встановлення розширення детально описані в розділі [інструментування без коду](/docs/zero-code/php/auto/#install-the-opentelemetry-extension).
