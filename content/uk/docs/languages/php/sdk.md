...
### Конфігурація з php.ini {#configuration-from-php-ini}

При наданні конфігурації через `php.ini`, обовʼязково захищайте булеві значення, подвійно цитуючи їх, наприклад, `"true"`, `"false"`, щоб PHP не перетворював їх на числа.
