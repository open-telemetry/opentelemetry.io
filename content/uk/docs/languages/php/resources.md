...
Стандартно використовуються всі детектори ресурсів SDK, але ви можете використовувати змінну середовища `OTEL_PHP_RESOURCE_DETECTORS`, щоб увімкнути лише певні детектори або повністю вимкнути їх:
