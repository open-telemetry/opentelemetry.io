...
Запустіть застосунок з деякими значеннями, встановленими в `OTEL_RESOURCE_ATTRIBUTES`, наприклад, ми встановили `host.name`, щоб ідентифікувати [Хост][host]:
...
До конфігурації можна додати більше детекторів ресурсів, наприклад, щоб отримати деталі про ваше [Хмарне][cloud] середовище або [Розгортання][deployment]. Для отримання додаткової інформації дивіться [пакунки з назвою `resource-detector-*` у сховищі opentelemetry-js-contrib](https://github.com/open-telemetry/opentelemetry-js-contrib/tree/main/packages).
