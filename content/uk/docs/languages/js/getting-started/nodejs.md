...
Спочатку встановіть Node SDK та пакунок автонструментування.
...
Щоб знайти всі модулі автонструментування, ви можете подивитися [реєстр](/ecosystem/registry/?language=js&component=instrumentation).
...
Тепер ви можете запустити ваш застосунок, як зазвичай, але ви можете використовувати прапорець `--require`, щоб завантажити інструментування перед кодом застосунку. Переконайтеся, що у вас немає інших конфліктуючих прапорців `--require`, таких як `--require @opentelemetry/auto-instrumentations-node/register` у вашій змінній середовища `NODE_OPTIONS`.
...
Згенерований відрізко відстежує тривалість запиту до маршруту `/rolldice`.
