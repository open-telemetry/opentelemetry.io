...
SDK OpenTelemetry JavaScript запускає тести продуктивності на кожному коміті до репозиторію [opentelemetry-js](https://github.com/open-telemetry/opentelemetry-js/). Метою цих тестів є відстеження тенденцій продуктивності критичних операцій з часом. Ці тести не є заміною для кінцевого тестування продуктивності.
