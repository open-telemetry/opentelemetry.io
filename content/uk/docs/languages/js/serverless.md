...
Нижче показано, як інструментувати [функцію](https://cloud.google.com/functions/docs/writing/write-http-functions), що спрацьовує на HTTP-запити, за допомогою інтерфейсу користувача Google Cloud Platform (GCP).
