...
{{% uk/docs/languages/libraries-intro "dotnet" %}}
...
Після налаштування бібліотек інструментування, ви можете додати власне [інструментування](/docs/languages/net/instrumentation) до вашого коду, щоб збирати користувацькі телеметричні дані.

Якщо ви використовуєте .NET Framework 4.x замість сучасного .NET, зверніться до [документації .NET Framework](/docs/languages/net/netframework) для налаштування OpenTelemetry та бібліотек інструментування на .NET Framework.

Вам також потрібно налаштувати відповідний експортер для [експорту ваших телеметричних даних](/docs/languages/net/exporters) до одного або більше бекендів телеметрії.

Ви також можете перевірити [автоматичне інструментування для .NET](/docs/zero-code/net), яке наразі знаходиться в бета-версії.
