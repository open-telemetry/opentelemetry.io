...
Не обовʼязково впроваджувати трасувальник на рівні сервісу, і це також не покращує продуктивність. Вам потрібно вирішити, де ви хочете, щоб ваш екземпляр трасувальника існував.
...
Після налаштування ручного інструментування, ви можете захотіти використовувати [бібліотеки інструментування](/docs/languages/net/libraries). Бібліотеки інструментування інструментуватимуть відповідні бібліотеки, які ви використовуєте, і генеруватимуть дані для таких речей, як вхідні та вихідні HTTP-запити та інше.

Вам також потрібно буде налаштувати відповідний експортер для [експорту ваших телеметричних даних](/docs/languages/net/exporters) до одного або більше бекендів телеметрії.
