...
Після того, як ви автоматично згенеруєте спостережуваність за допомогою інструментальних бібліотек, ви можете додати [ручне інструментування](/docs/languages/net/instrumentation) для збору користувацьких телеметричних даних.

Вам також потрібно буде налаштувати відповідний експортер для [експорту ваших телеметричних даних](/docs/languages/net/exporters) до одного або декількох бекендів телеметрії.

Ви також можете перевірити [автоматичне інструментування для .NET](/docs/zero-code/net), яке наразі
