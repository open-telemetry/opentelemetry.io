...
## Автоматичне поширення контексту {#automatic-сontext-propagation}
...
Щоб дізнатися більше про поширення, дивіться [API Поширбвачів](/docs/specs/otel/context/api-propagators/).
