...
Якщо ви використовуєте [mypy](https://mypy-lang.org/), вам потрібно увімкнути [пакунок простору імен](https://mypy.readthedocs.io/en/stable/command_line.html#cmdoption-mypy-no-namespace-packages), інакше `mypy` не зможе працювати правильно.
