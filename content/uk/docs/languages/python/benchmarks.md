...
OpenTelemetry Python SDK запускає тести продуктивності на кожному коміті до репозиторію [opentelemetry-python](https://github.com/open-telemetry/opentelemetry-python/). Мета цих тестів — відстежувати тенденції продуктивності критичних операцій з часом. Ці тести не є заміною для кінцевого тестування продуктивності.
