...
OpenTelemetry-Python підтримує Python 3.10 і вище.
...
Є деяка функціональність, яка ще не була випущена на PyPI. У такій ситуації ви можете встановити пакунки безпосередньо з репозиторію. Це можна зробити, клонуючи репозиторій та виконуючи [редаговане встановлення](https://pip.pypa.io/en/stable/topics/local-project-installs/#editable-installs):
