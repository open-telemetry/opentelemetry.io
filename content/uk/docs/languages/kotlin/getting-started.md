...
weight: 10
default_lang_commit: 4817df9f058ba3adcd78df54d30881502296d58a
---
...
> [!NOTE]
>
> Для платформ iOS та JavaScript ваш проєкт повинен використовувати версію Kotlin не старішу за ту, з якою було зібрано OpenTelemetry Kotlin. Для деталей див. [KT-76131](https://youtrack.jetbrains.com/issue/KT-76131).
