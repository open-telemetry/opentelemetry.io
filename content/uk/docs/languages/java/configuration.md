...
Усі компоненти SDK мають [програмні інтерфейси налаштування](#programmatic-configuration). Це найгнучкіший і найвиразніший спосіб налаштування SDK. Однак зміна налаштувань вимагає коригування коду та перекомпіляції застосунка, і немає міжмовної сумісності, оскільки API написано на Java.
...
| Системна властивість                               | Опис                                                                                                                                                             | Стандартно       |
| -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| `otel.experimental.metrics.cardinality.limit`      | Якщо встановлено, налаштуйте обмеження кардинальності. Значення визначає максимальну кількість різних точок на метрику. Ця опція є експериментальною і може бути змінена або видалена. | `2000`           |
...
| `otel.exporter.otlp.timeout`                                    | Максимальний час очікування, у мілісекундах, дозволений для відправки кожного пакету OTLP трасування, метрик та логів.                                                                                                                                                                                                                                                                                                           | `10000`                                                                                                                    |
| `otel.exporter.otlp.{signal}.timeout`                           | Максимальний час очікування, у мілісекундах, дозволений для відправки кожного пакету OTLP {signal}.                                                                                                                                                                                                                                                                                                                              | `10000`                                                                                                                    |
...
| `otel.java.exporter.otlp.retry.enabled`                         | Якщо `true`, повторіть спробу при виникненні тимчасових помилок. **[2]**                                                                                                                                                                                                                                                                                                                                                         | `true`                                                                                                                     |
