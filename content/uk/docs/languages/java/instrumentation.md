...
- [Метрики JMX](../jmx/) для моніторингу JVM та метрик застосунку через JMX MBeans
...
Шим (прокладка) — це вид інструментування, який переносить дані з однієї бібліотеки спостережуваності в іншу, зазвичай _з_ якоїсь бібліотеки в OpenTelemetry.
