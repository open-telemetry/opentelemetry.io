...
Бекенд Jaeger може отримувати дані трасування використовуючи протокол OpenTelemetry (OTLP) з версії v1.35. Ви можете мігрувати свої OpenTelemetry SDK та Колектори з експортера Jaeger на експортер OTLP.
