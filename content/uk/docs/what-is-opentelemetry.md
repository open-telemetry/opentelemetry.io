...
- [Специфікація](../specs/otel) для всіх компонентів
- Стандартний [протокол](../specs/otlp/), який визначає форму телеметричних даних
- [Семантичні домовленості](../specs/semconv/), які визначають стандартну схему найменування для типів телеметричних даних
