...
- [Docker Compose](https://docs.docker.com/compose/install/)
  v2.0.0+
- Make (опціонально)
- 6 ГБ оперативної памʼяті для застосунку (або ~3 ГБ у
  [мінімальному режимі](#run-in-minimal-mode))
...
### Запуск у мінімальному режимі {#run-in-minimal-mode}

Якщо у вас обмежені ресурси, ви можете запустити демо без Kafka та її залежних служб, зменшивши використання памʼяті приблизно до 3 ГБ:
...
Наступні служби **не** включені в мінімальний режим:
