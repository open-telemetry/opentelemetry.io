...
| [frontend-proxy](frontend-proxy/)     | Envoy      | Зворотний проксі, який обслуговує вебмагазин та інтерфейси спостереження на одному порту.                                                           |
| [image-provider](image-provider/)     | NGINX      | Статично розміщує зображення товарів, які використовує фронтенд.                                                                                    |
| [Kafka](kafka/)                       | Java       | Черга повідомлень, що зʼєднує службу оформлення замовлень зі службами бухгалтерського обліку та виявлення шахрайства.                               |
| [load-generator](load-generator/)     | Python     | Постійно надсилає запити, імітуючи реалістичні потоки покупок користувачів на фронтенд.                                                             |
