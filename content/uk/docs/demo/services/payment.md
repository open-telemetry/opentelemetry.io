...
Лічильники та інструменти призначені для постійного використання. Це означає, що ви повинні отримати лічильник або інструмент один раз, а потім використовувати його повторно за потреби, якщо це можливо.
...
```javascript
// перевірка baggage на synthetic_request=true та додавання атрибута charged відповідно
