...
Застосунок React Native надає мобільний інтерфейс для користувачів на пристроях Android та iOS для взаємодії з демонстраційними сервісами. Він створений за допомогою [Expo](https://docs.expo.dev/get-started/create-a-project/) і використовує файлову маршрутизацію Expo для компонування екранів застосунку.
