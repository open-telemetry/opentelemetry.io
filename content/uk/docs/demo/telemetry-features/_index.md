...
- **[OpAMP](/docs/specs/opamp/)**: OpenTelemetry Collector повідомляє про стан, версію, атрибути та ефективну конфігурацію серверу OpAMP демо. Ви можете переглянути повідомлений стан у інтерфейсі OpAMP за адресою <http://localhost:8080/opamp/>.
- **SDK Self-Observability**: лише вибрані сервіси беруть участь у експериментальних внутрішніх метриках `otel.sdk.*`, що генеруються самими SDK OpenTelemetry, і показуються на [панелі самоспостереження](/docs/demo/self-observability-dashboard/).

## Рішення для спостереження {#observability-solutions}

- **[Grafana](https://github.com/grafana/grafana)**: всі метрики зберігаються в Grafana.
...
- **[Envoy](https://www.envoyproxy.io/)**: Envoy використовується як зворотний проксі для вебінтерфейсів, орієнтованих на користувача, таких як фронтенд та сервіс функцій.
- **[k6](https://k6.io)**: фонове завдання, яке створює реалістичні шаблони використання на вебсайті за допомогою синтетичного генератора навантаження.
