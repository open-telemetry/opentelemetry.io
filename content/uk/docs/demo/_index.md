...
| JavaScript | [Сервіс платежів](services/payment/)                                                                                                                |                                                                                                          | [Сервіс платежів](services/payment/)                                                                     |
...
| Python     | [Сервіс рекомендацій](services/recommendation/), [Сервіс Агента](services/agent/), [Сервіс Чатбота](services/chatbot/), [Сервіс MCP](services/mcp/) |                                                                                                          | [Сервіс рекомендацій](services/recommendation/)                                                          |
...
Специфічна інформація про те, як OpenTelemetry розгорнуто в кожному сервісі, може бути знайдена тут:

- [Сервіс бухгалтерії](services/accounting/)
- [Сервіс реклами](services/ad/)
- [Сервіс Агента](services/agent/)
- [Сервіс Чатбота](services/chatbot/)
