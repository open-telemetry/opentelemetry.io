...
## Встановлення за допомогою Helm {#install-using-helm}
...
### Використання Helm для генерації маніфестів Kubernetes {#use-helm-to-generate-a-kubernetes-manifests}

Наступна команда згенерує один файл маніфесту Kubernetes, який міститиме визначення всіх необхідних ресурсів. Ви можете застосувати цей маніфест за допомогою `kubectl apply -f opentelemetry-demo.yaml` після його генерації.
