...
Повертаючись до інтерфейсу пошуку, відфільтруйте `recommendationservice` у меню Service та шукайте `app.cache_hit=true` у полі Tags. Зверніть увагу, що запити, як правило, швидші, коли кеш влучає. Тепер шукайте `app.cache_hit=false` і порівняйте затримку. Ви повинні помітити деякі зміни у візуалізації у верхній частині списку трейсів.
