...
> [!NOTE]
>
> Для ізольованих середовищ (air-gapped environments) використовуйте змінну `LOCAL_PATH`, щоб надати файл інсталяції безпосередньо:
>
> ```shell
> LOCAL_PATH=<PATH_TO_INSTALLER> sh ./otel-dotnet-auto-install.sh
> ```
>
> Або використовуйте `DOWNLOAD_DIR`, щоб надати теку з файлами, і скрипт встановлення визначить правильний файл для використання:
>
> ```shell
...
Ви можете інструментувати [`самостійні`](https://learn.microsoft.com/en-us/dotnet/core/deploying/#publish-as-self-contained) застосунки, використовуючи NuGet пакунки. Дивіться [NuGet пакунки](./nuget-packages) для отримання додаткової інформації.
