...
| `PROCESS`         | Детектор процесів               | [Документація детектора ресурсів процесів](https://github.com/open-telemetry/opentelemetry-dotnet-contrib/blob/Resources.Process-1.15.1-beta.1/src/OpenTelemetry.Resources.Process/README.md)                                               | [Експериментальний](/docs/specs/otel/versioning-and-stability) |
