...
Модуль автоконфігурації SDK використовується для базової конфігурації агента. Прочитайте [документацію](/docs/languages/java/configuration), щоб знайти налаштування, такі як конфігурація експорту або вибірки.
