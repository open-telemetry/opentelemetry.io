...
weight: 100
default_lang_commit: 57e25d9d47f3ed119d8be382b4cb13c6cdf5bdf4
...
Ця поведінка стандартно увімкнена для всіх інструментів бази даних.

> [!WARNING] :warning: Вимкнення цієї функції НЕ рекомендується.
>
> Це може призвести до витоку чутливої інформації, зокрема персональних даних (PII) або облікових даних безпеки, за межі периметра вашого застосунку.

Використовуйте наступну властивість, щоб вимкнути її:
