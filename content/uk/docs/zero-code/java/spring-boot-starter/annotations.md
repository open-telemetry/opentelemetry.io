...
{{< comment >}} Зверніть увагу, що нам доводиться використовувати шорткод alert, оскільки тут містяться вкладки.
...
У [декларативній конфігурації](../declarative-configuration/) використовуйте централізовані списки інструменталізації для вимкнення анотацій:
