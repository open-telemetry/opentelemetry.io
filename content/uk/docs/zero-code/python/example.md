...
> **Примітка**: Щоб використовувати автоматичне інструментування через `opentelemetry-instrument`, ви повинні налаштувати його через змінні середовища або командний рядок. Агент створює конвеєр телеметрії, який не можна змінити іншим способом, окрім цих засобів. Якщо вам потрібна більша кастомізація для ваших конвеєрів телеметрії, тоді вам потрібно відмовитися від агента та імпортувати OpenTelemetry SDK та бібліотеки інструментування у ваш код і налаштувати їх там. Ви також можете розширити автоматичне інструментування, імпортуючи OpenTelemetry API. Для отримання додаткової інформації дивіться [API reference][].
