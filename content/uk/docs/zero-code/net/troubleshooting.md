...
1. [**Monkey-патчинг**](https://en.wikipedia.org/wiki/Monkey_patch#:~:text=Monkey%20patching%20is%20a%20technique,Python%2C%20Groovy%2C%20etc.) збірок, завантажених як нейтральні до домену.
2. Перенаправлення збірок для застосунки зі строгими іменами, якщо застосунок також містить різні версії деяких збірок, також поставлених у теці `netfx`.
