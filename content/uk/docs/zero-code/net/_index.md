...
Щоб дізнатися, як інструментувати ваш сервіс або застосунок, прочитайте [Ручне інструментування](/docs/languages/net/instrumentation).
...
Після того, як ви налаштували автоматичне інструментування для вашого застосунку або сервісу, ви можете [надсилати власні трасування та метрики](./custom) або додати [ручне інструментування](/docs/languages/net/instrumentation) для збору власних телеметричних даних.
