...
Ця сторінка покаже вам, як почати роботу з автоматичною інструментацією OpenTelemetry .NET.

Якщо ви шукаєте спосіб вручну інструментувати ваш застосунок, перегляньте [цей посібник](/docs/languages/net/getting-started).
...
Наступний приклад використовує базовий [Мінімальний API з ASP.NET Core](https://learn.microsoft.com/aspnet/core/tutorials/min-web-api) застосунок. Якщо ви не використовуєте ASP.NET Core, це не проблема — ви все одно можете використовувати автоматичну інструментацію OpenTelemetry .NET.
...
Для початку створіть нову текуз назвою `dotnet-simple`. У цій теці виконайте наступну команду:
...
## Інструментація {#instrumentation}

Далі ви будете використовувати [автоматичну інструментацію OpenTelemetry .NET](../) застосунку під час запуску. Хоча ви можете [налаштувати автоматичну інструментацію .NET][] різними способами, нижче наведені кроки для Unix-shell або PowerShell скриптів.
...
2. Виконайте наступний скрипт для завантаження автоматичної інструментації для вашого середовища розробки:
...
Також при зупинці сервера ви повинні побачити вивід всіх зібраних метрик (приклад уривку показано):
...
- Дивіться список [доступних інструментацій](../instrumentations)
- Якщо ви хочете поєднати автоматичну та ручну інструментацію, дізнайтеся, як ви [можете створювати власні трейси та метрики](../custom)
...
[налаштувати автоматичну інструментацію .NET]: ../configuration
