...
Обчислювати метрики мережевого рівня простіше, ніж метрики рівня застосунків, оскільки OBI надає лише один лічильник: `obi.network.flow.bytes`. Однак кардинальність також залежить від того, наскільки ваші програми взаємопов'язані.
