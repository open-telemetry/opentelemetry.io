...
OBI v0.12.1 — це опублікована версія змін, підготовлених для v0.12.0. Хоча версія v0.12.0 була позначена тегом, її не було опубліковано через невдалу перевірку релізу. Встановіть версію v0.12.1, яка містить заплановані зміни для v0.12.0 та виправлення, повʼязані з випуском.
