...
> [!NOTE]
>
> Ця сторінка використовує імена полів Config v1 та приклади. У Config v2 налаштуйте вибірку через поле верхнього рівня `tracer_provider.sampler`; див. [довідку по Config v2](../config-v2/). Для конвертації наявного файлу використайте [посібник з міграції](../migrate-to-config-v2/).
