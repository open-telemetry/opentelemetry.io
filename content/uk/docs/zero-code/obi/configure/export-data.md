...
- `application_service_graph`: Метрики на рівні графа сервісів застосунку. Рекомендується використовувати DNS для виявлення сервісів і забезпечити відповідність імен DNS з іменами сервісів OpenTelemetry, які використовує OBI. У середовищах Kubernetes, найкращим вибором для метрик графа сервісів є ім'я сервісу OpenTelemetry, встановлене виявленням імені сервісу.
