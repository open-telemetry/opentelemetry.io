...
- Локальна копія репозиторію [OpenTelemetry eBPF Instrumentation](https://github.com/open-telemetry/opentelemetry-ebpf-instrumentation) версії v0.5.0 чи новіше
...
Створіть конфігураціюOpenTelemetry Collector, що включає приймач OBI:
