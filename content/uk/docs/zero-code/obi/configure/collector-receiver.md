...
> [!NOTE]
>
> OBI v0.11.0 і пізніші версії підтримують Config v1 та Config v2 для приймача OBI Collector. Приклади на цій сторінці використовують Config v1. Щоб налаштувати приймач з Config v2, див. [Довідник Config v2](../config-v2/#collector-receiver-configuration) або дотримуйтесь [інструкцій з міграції приймача](../migrate-to-config-v2/#migrate-a-collector-receiver).
...
graph TD
    ...
    subgraph Collector[OpenTelemetry Collector]
        OBI[Приймач OBI<br/>Інструментування eBPF]
...
Так само як і самостійний OBI, інструментування eBPF забезпечує мінімальні накладні витрати. Конвеєр Колектора додає додаткові вимоги до ресурсів, які залежать від вашої конфігурації.
