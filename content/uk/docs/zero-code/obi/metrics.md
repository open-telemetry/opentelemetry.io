...
| Application | `messaging.publish.duration`       | `messaging_publish_duration`               | Histogram | seconds | Тривалість операцій публікації повідомлень у підтримуваних системах, таких як Kafka, MQTT, NATS та AMQP (Експериментально) |
| Application | `messaging.process.duration`       | `messaging_process_duration`               | Histogram | seconds | Тривалість операцій обробки повідомлень у підтримуваних системах, таких як Kafka, MQTT, NATS та AMQP (Експериментально)    |
