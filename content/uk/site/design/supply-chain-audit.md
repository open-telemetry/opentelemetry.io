...
11. **Кожна перевірка мусить виправдовувати своє існування.** Безпека забезпечується завдяки конструкції засобів контролю та процесу перевірки, а не накопиченням тверджень: кожне з них обтяжує учасників та розробників при кожному втручанні. Перевірка має місце лише тоді, коли вона виявляє те, чого рецензія явно не може виявити: непрозору поверхню з високим рівнем авторитету, таку як блокування, або семантику, занадто незрозумілу, щоб її можна було помітити на око. Якщо засіб контролю вже не працює під час виконання, аудит не підтверджує його знову; коли витрати на підтримку перевірки перевищують її цінність для виявлення, її скорочення є правильним кроком, а не послабленням.
...
| Checks earn their keep  | Мінімуми межі рушіїв вирішуються рецензуванням; `engine-strict` забезпечує їх                   |
