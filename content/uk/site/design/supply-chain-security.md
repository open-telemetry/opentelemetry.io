...
- _Встановлення, яке визначає діапазони версій, може завантажити щойно опублікований шкідливий випуск._
  ...
  - **Явне визначення версій**: <a id="deliberate"></a> визначення версій відбувається лише під час [навмисних оновлень залежностей][dep-updates], ніколи як побічний ефект встановлення.
    - Заплановане перевизначення блокування від Renovate ([`lockFileMaintenance`][]) вимкнено за дизайном: постійне отримання всього дерева з реєстру дає лише рутинну транзитивну свіжість, яку [виправлення за сповіщеннями][security updates] уже покривають.
  - **Визначення версій лише для випусків, що відстоялися**: <a id="cooldown-releases"></a> навіть явне визначення версій ігнорує випуски, молодші за [період охолодження][cooldown]; відкликання шкідливих випусків на стороні реєстру потребує кількох днів.
    - Один виняток за дизайном: [безпекові оновлення Dependabot][security updates] постачають виправлення відомих вразливостей негайно.
    - Охолодження охоплює пакунки, визначені з реєстру; закріплення інструментарію Node натомість слідує [політиці мінімальної версії][npm engines floor], оскільки підписані збірки проєкту не поділяють ризику затримки відкликання реєстру.
...
| [Явне визначення версій][Resolve deliberately]                                             | [Конвенція][dep-updates] і вимкнений [`lockFileMaintenance`][] у [`renovate.json5`][]                                                                         |
| [Визначення версій лише для випусків, що відстоялися][Resolve only cooled-down releases]   | [Охолодження][cooldown] в npm і [Renovate][`renovate.json5`]                                                                                                  |
