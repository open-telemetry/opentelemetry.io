...
Серед складених тестових наборів, `test:local-tools` також містить [аудит ланцюга постачання](../build/dependencies/#audit), який не проходить, коли регресує зафіксований контроль жорсткості встановлення; ця сторінка охоплює, що робити, коли він спрацьовує.
