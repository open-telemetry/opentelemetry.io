...
- У [`.github/CODEOWNERS`][], надайте команді локалізації **повну** власність над її файлами. Дотримуйтесь вказівок у файлі.
- Зберігайте записи в алфавітному порядку.
- **Не додавайте** жодних записів до [`.github/component-owners.yml`][]; зміни до цього файлу більше не потрібні з червня 2026 року.
...
- [ ] **Крок 5** — `.github/component-label-map.yml` (введення міток) та `.github/CODEOWNERS` (блок у повному володінні) оновлено для локалі
