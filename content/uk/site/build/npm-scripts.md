...
| Скрипт            | Опис                                                                                                                            |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| `ci:min`          | [Точне інертне встановлення][lock-exact inert install] для CI: без скриптів життєвого циклу.                                    |
...
| `install:safe`    | [Точне локальне налаштування][lock-exact local setup]: інертне встановлення, потім `ci:prepare`.                                |
