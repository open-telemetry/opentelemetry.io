...
Керування мітками затвердження PR на основі стану рецензії та власності файлів. Викликається робочим процесом [`label-manager`](../ci-workflows/#pr-approval-labels).
