...
- **[Операції з базами даних](/docs/specs/semconv/database/database-spans)** — пакетні операції мають властивості, які прості атрибути не можуть адекватно відобразити
