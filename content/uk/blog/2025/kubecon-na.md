...
Учасники проєкту OpenTelemetry, члени керівного комітету та технічного комітету з нетерпінням чекають на участь у конференції [KubeCon NA][], яка відбудеться в Атланті з 10 по 13 листопада 2025 року. [Зареєструйтеся][register] вже сьогодні, щоб приєднатися до нас!
...
- **[Sync or Swim: Building Platforms You Can See](https://sched.co/27FY4)**<br>
  ...
  Вівторок, 11 листопада • 17:45 – 18:15
...
> [!IMPORTANT] Важлива інформація щодо доступу
>
...
> [!IMPORTANT] Важлива інформація щодо доступу
>
> Вам буде потрібен _all-access_ пропуск для участі в **Observability Day**. Детальніше див. [Реєстрація][register].

## Обсерваторія OpenTelemetry {#opentelemetry-observatory}

Завітайте та привітайтеся в OpenTelemetry Observatory, яку представляє Splunk в експозалі. Це буде місце для неформальних бесід, зустрічей та інших дискусій, які проводитимуть члени спільноти та адміністратори OpenTelemetry, наприклад:
