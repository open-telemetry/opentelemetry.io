...
Ця інструкція перетворення використовує `Split` для розділення тіла на частини за допомогою роздільника `"},"`, створюючи тіло у вигляді списку, яке процесор розгортання може розгорнути.
...
Процесор розгортання тепер доступний в офіційному [OpenTelemetry Collector Contrib](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/635d4254a3018eb3ca8f1736e71fcb54f8ed6e5a/processor/unrollprocessor?from_branch=main). Не соромтеся створювати запити та тестувати його для своїх конвеєрів журналів.
