...
Щоб ваша організація була включена до списку, [надішліть PR][submit a PR] з записом, доданим до [списку вендорів][vendors list]. Запис повинен включати наступне:
