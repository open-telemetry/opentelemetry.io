...
Щоб ваш дистрибутив був включений до списку, [надішліть PR] з записом, доданим до [списку дистрибутивів](https://github.com/open-telemetry/opentelemetry.io/tree/main/data/ecosystem/distributions.yaml). Запис повинен містити наступне:
